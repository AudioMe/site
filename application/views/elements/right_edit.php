...
<div class="div_finde">
    ...
    <form method="post" action="/">
        <div class="finde_chech_top">
            <p class="p_top">
                <input class="prettyRadio" type="radio" id="studio_top" name="studio_type"/>
                <label for="studio_top">от 900 руб. / час</label>
            </p>

            <p class="p_price">
                <input class="prettyRadio" type="radio" checked id="studio_price" name="studio_type"/>
                <label for="studio_price">от 500 до 900 руб. / час</label>
            </p>

            <p class="p_freel">
                <input class="prettyRadio" type="radio" id="studio_freel" name="studio_type"/>
                <label for="studio_freel">до 500 руб. / час</label>
            </p>
        </div>
        <h2 class="hFinde">Услуги:</span></h2>
        ...
        <div class="check_bottom">
            ...
            foreach ($works_temp as $w) {
                ?>
                <p>
                    <input type="checkbox" class="prettyRadio check_register" id="find_check<?php echo $w->id; ?>"
