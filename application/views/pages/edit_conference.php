...
<div id="comment-form" class="comment-form">
    ...
    <div id="respond">
        <form action="/editSave/conference" onsubmit="" enctype="multipart/form-data" method="post" id="commentform" class="ui_form">
            <input type="hidden" name="conference_id" value="<?php if (isset($news->id)) echo $news->id; ?>" />
            <div>
                <label for="ntitle">Заголовок конференции <span class="required cherry">*</span></label>
            ...
            <div>
                <label for="npreview">Краткое содержание корференции<span class="required cherry">*</span></label>
            ...
            <div>
                <label for="ntext">Текст конференции</label>
                <textarea id="ntext" class="ui_textarea" name="ntext" cols="45" rows="8" aria-required="true"><?php if (isset($news->text)) echo $news->text; ?></textarea>
            </div>
            <div>
            ...
            <div>
                <input name="btnsubmconference" class="ui_button common m_b_20" type="submit" id="submit" value="Сохранить"/>
            </div>
        </form>
    </div>
</div>
...
if (isset($images)) {
    ?>
        ...
        foreach ($images as $image) {
            ?>
            <div class="dir_photo">
                <a href="/remove/conferencePhoto/<?php echo $image->id; ?>" class="img_remove"></a>
              <img src="/files/<?php echo $news->user_id. "/conference/prev_" . $image->id.".png"; ?>" width="160">
            </div>
