    ...
    ?>
                    <div class="p_info_block clearfix studio_one">
                        <div class="p_logo_studia <?php echo $add_class;?>">
                            <?php if (isset($studio->photo) && strlen($studio->photo) > 3) {?>
                            <img class="b_round wh170" src="<?php echo $studio->photo; ?>"/>
                            <?php } else { ?>
                ...
                <div id="respond" class="tab1 p_comments_block">
                    <form action="/addFree/comments/<?php echo $studio_id; ?>" onsubmit="return valid_form()"
                        ...
                        <div class="clerfix">
                            ...
                            <div class="right buttonsC" style="">
                            <?php if ($next_id) { ?>
                            <input id="nextStudio" name="nextStudio" onclick="location.href='/studio/view/<?php echo $next_id;?>'" class="ui_button" type="button" id="nextStudios" value="Следующая студия"/>
                            <?php }?>
