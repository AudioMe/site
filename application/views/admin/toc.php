...
<div id="comment-form" class="comment-form">
    <div id="respond">
        <form action="/adminSave/toc" onsubmit="" method="post" id="commentform">
            <p class="comment-form-comment">
                <label for="ntext">Условия использования<span class="required">*</span></label>
                <textarea id="ntext" class="input100" name="ntext" cols="45" rows="20"
                          aria-required="true"><?php if (isset($toc)) echo $toc; ?></textarea>
            </p>
...
<script type="text/javascript">
    jQuery(function () {
        jQuery('#menu_nav17').addClass("active");
