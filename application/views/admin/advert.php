...
<div id="comment-form" class="comment-form">
    ...
    <div id="respond">
        <form action="/adminSave/advert" onsubmit="" method="post" id="commentform">
            <p class="comment-form-comment">
                <label for="ntext">Реклама<span class="required">*</span></label>
                <textarea id="ntext" class="input100" name="ntext" cols="45" rows="20"
                          aria-required="true"><?php if (isset($advert)) echo $advert; ?></textarea>
            </p>
...
<script type="text/javascript">
    jQuery(function () {
        jQuery('#menu_nav10').addClass("active");
