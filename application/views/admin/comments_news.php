<table class="table">
    ...
    if (isset($comments))
        foreach ($comments as $comment) {
            ?>
            <tr>
                <td><a href="/admin/commentNews/<?php echo $comment->id; ?>"><?php echo $comment->text; ?></a></td>
                <td style="text-align: right">
                    <?php echo $comment->phone; ?>
                </td>
                <td><a href="/adminDelete/commentNews/<?php echo $comment->id; ?>"
...
<script type="text/javascript">
    jQuery(function () {
        jQuery('#menu_nav11').addClass("active");
