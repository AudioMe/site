...
<div id="comment-form" class="comment-form">
    <div id="respond">
        <form action="/adminSave/partners" onsubmit="" method="post" id="commentform">
            <p class="comment-form-comment">
                <label for="ntext">Информация о партнёрах<span class="required">*</span></label>
                <textarea id="ntext" class="input100" name="ntext" cols="45" rows="20"
                          aria-required="true"><?php if (isset($partners)) echo $partners; ?></textarea>
            </p>
...
<script type="text/javascript">
    jQuery(function () {
        jQuery('#menu_nav9').addClass("active");
