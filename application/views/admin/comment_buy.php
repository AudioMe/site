<table style="width:100%">
    <tr>
        <td>
            <form action="/adminSave/commentBuy" method="post">
                <input type="hidden" name="comment_id" value="<?php if (isset($comment->id)) echo $comment->id; ?>" />
                <textarea style="width:100%" name="text"><?php if (isset($comment->text)) echo $comment->text;  ?></textarea>
        ...
        <td style="width:100px; text-align: right">
            <a href="/adminDelete/commentBuy/<?php if (isset($comment->id)) echo $comment->id; ?>" class="remove_comments btn btn-danger">Удалить</a>
        </td>
    </tr>
</table>
