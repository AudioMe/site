...
var XPrecise = {
	...
	overlayPosition : function () {
		...
		var top_field = jQuery("#xprecise-top")
			...
			top_field.keypress(function (event) {
            ...
            left_field.keypress(function (event) {
                if( event.keyCode == 38) //top
                {
                    jQuery(this).val( parseInt(jQuery(this).val())-1 );
	...
	getImageFromURL : function () {
		...
		url_parts.reverse();
		if (url_parts[0] !== '') {
			image_name = '_xprecise/o/' + url_parts[0].replace(/.html/, '.jpg');
		} else {
			image_name = '_xprecise/o/index.jpg';
		}
		return image_name;
	},
	saveSettings : function () {
		var delimiter = '|';
		var interface_toggle,
		overlay_toggle,
		over_under;
	...
	interfaceAppend : function () {
		...
		jQuery('head').append('<link rel="stylesheet" type="text/css" media="all" href="_xprecise/css/xprecise.css" />');
